...
urlpatterns = patterns('condottieri_scenarios.views',
	...
	url(r'^setting/disasters/(?P<slug>[-\w]+)/$',
		views.DisasterTableView.as_view(), name='setting_disasters'),
	url(r'^create/$',
	...
	url(r'^area/list/(?P<slug>[-\w]+)/$',
		views.SettingAreasView.as_view(), name='setting_areas'),	
	url(r'^area/create/(?P<slug>[-\w]+)/$',
